            ...
            <div class="col-lg-8 col-xl-7 col-xxl-6">
                <div class="my-5 text-center text-xl-start">
                    ...
                    <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xl-start">
                        <strong a class="btn btn-light btn-lg px-4 me-sm-3" href="#features">Let's
                            Join!</strong>
                    </div>
                </div>
            </div>
            <div class="col-xl-5 col-xxl-6 d-none d-xl-block text-center"><img class="img-fluid rounded-4 my-5"
                    src="https://www.maxmanroe.com/vid/wp-content/uploads/2018/09/Pengertian-Sekolah.jpg" alt="..." /></div>
        </div>
    </div>
</header>
<!-- Features section-->
        ...
        <div class="row gx-5 justify-content-center">
            <div class="col-lg-10 col-xl-7">
                <div class="text-center">
                    ...
                    <div class="fs-4 mb-4 fst-italic">”Menuntut ilmu itu wajib atas setiap muslim”. (HR. Ibnu Majah. Dinilai shahih oleh Syaikh Albani dalam Shahih wa Dha’if Sunan Ibnu Majah no. 224)</div>
        ...
        <div class="row gx-5">
            <div class="col-lg-4 mb-5">
                <div class="card h-100 shadow border-0">
                    <img class="card-img-top" src="https://unpi-cianjur.ac.id/assets/images/berita/alasan_mengapa_data_pribadi_perlu_dilindungi_unpi_1bb.jpg" alt="..." />
            ...
            <div class="col-lg-4 mb-5">
                <div class="card h-100 shadow border-0">
                    <img class="card-img-top" src="http://www.unpi-cianjur.ac.id/assets/images/berita/meltdown_dan_spectre__menghantui_android__iphone__mac___windows_unpi_1cd.jpg" alt="..." />
                    <div class="card-body p-4">
            ...
            <div class="col-lg-4 mb-5">
                <div class="card h-100 shadow border-0">
                    <img class="card-img-top" src="https://unpi-cianjur.ac.id/assets/images/berita/menristekdikti_bahas_pengembangan_universitas_siber_di_seoul_unpi_427.jpg" alt="..." />
                    <div class="card-body p-4">
                        <div class="badge bg-primary bg-gradient rounded-pill mb-2">News</div>
                        <a class="text-decoration-none link-dark stretched-link" href="#!">
