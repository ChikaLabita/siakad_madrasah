        ...
        <div class="row">
            <div class="col">
                <div class="card border-0 shadow rounded">
                    <div class="card-header">Tambah Staff & Karyawan</div>
                    <div class="card-body">
                        <form action="{{ route('staff.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select id="jk" name="jk" class="form-control" placeholder="Select..">
                            ...
                            <a href="/staff" class="btn btn-md btn-secondary">BACK</a>
                            </div>
                        </form>
                    </div>
                </div>
